...
for /f "Tokens=* Delims=" %%x in ('powershell -NoProfile -ExecutionPolicy ByPass "& ..\..\..\Tools-Local\CMake\Windows\Search-Tool.ps1 -ToolName CMake %__StrictToolVersionMatch%"') do set ProbeValue=!ProbeValue!%%x
