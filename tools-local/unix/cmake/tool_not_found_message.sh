...
# Gets the error message to be displayed when CMake is not available for the build.
...
# TODO: Consider reading this from a text file. The same can be done in Windows scripts.
...
echo >&2 "      2. Run the script $shellScriptsPath/acquire-tool.sh CMake"
