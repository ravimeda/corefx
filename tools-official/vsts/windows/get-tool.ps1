<#
.SYNOPSIS
    Downloads the declared version of the specified tool name from OSS Tools repository (https://ossmsft.visualstudio.com/dotnet/).
    Saves the downloaded copy in Tools/downloads folder in the repository root.
.PARAMETER ToolName
    Name of the tool.
...
function GetCMakePackageUrl
{
    ...
    return "https://ossmsft.visualstudio.com/dotnet/cmake/v$MajorMinorCMakeVersion/$($downloadObject.PackageNameWithExtension)"
}
